    ...
    public void definirEventos() {
        ...
        btGravar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(null, disciplinaDAO.atualizar(DisciplinaDAO.INCLUSAO));
                limparCampos();
            }
        });
        ...
        btAlterar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                disciplinaDAO.disciplina.setCarga_horaria(Integer.parseInt(tfCargaHoraria.getText()));
                disciplinaDAO.disciplina.setArea_materia(tfAreaMateria.getText());
                JOptionPane.showMessageDialog(null, disciplinaDAO.atualizar(DisciplinaDAO.ALTERACAO));
                limparCampos();
            }
        });
        ...
        btExcluir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (n == JOptionPane.YES_OPTION) {
                    JOptionPane.showMessageDialog(null, disciplinaDAO.atualizar(DisciplinaDAO.EXCLUSAO));
                    limparCampos();
                }
            }
        });
